...
const AmountInterest = (props) => {
    ...
    const handleSubmit = (e) => {
        ...
        let amountValue = [...display, { ...data1 }, { ...data2 }, ...data3]
        ...
        <div className="amount">
            <div className="amountForm">
                <form className="formValue" onSubmit={handleSubmit}>
                    ...
                    <div className="form-input"><select name="commPercent" value={values.commPercent ? values.commPercent : 1} onChange={handleChange}>
                    ...
                    <input type="button" className="form-clear" name="Clear" value="Clear" onClick={handleClear} />
                    <input type='submit' value="Calculate" className="form-calculate" />
                </form>

            </div>
            <div className="amountTable" ref={props.amountRef}>
